...
public class CenterObjectLogger : MonoBehaviour
{
    ...
    IEnumerator LoadLevel()
    {
        ...
        AsyncOperation asyncLoad = SceneManager.LoadSceneAsync("Scene1 - Dustin", LoadSceneMode.Single);
        ...
        Scene loadedScene = SceneManager.GetSceneByName("Scene1 - Dustin"); // Get the loaded scene by name
